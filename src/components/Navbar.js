    ...
    return (
        <div class="drawer drawer-end" data-theme={dark ? 'dark' : 'light'}>
            ...
            <div class="drawer-content flex flex-col">
                ...
                <div class="w-full navbar bg-base-100 shadow-lg px-8">
                    {pathname.includes('dashboard') && <label for="my-drawer-2" class="btn btn-square btn-ghost lg:hidden">
                        ...
                        <ul class="menu menu-horizontal gap-x-4">
                            ...
                            <li className='dropdown dropdown-hover dropdown-end'>
                                ...
                                <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                                    <li><NavLink className='rounded-lg' to=''>Item 1</NavLink></li>
                                    <li><NavLink className='rounded-lg' to=''>Item 2</NavLink></li>
                                </ul>
                            </li>
                            <li>
